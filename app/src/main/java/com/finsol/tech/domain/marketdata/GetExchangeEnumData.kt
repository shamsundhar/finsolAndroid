...
class GetExchangeEnumData @Inject constructor(private val repository: LoginResponseDataRepository) {
    suspend fun execute(): Flow<ResponseWrapper<Array<ExchangeEnumModel>>> {
        return repository.getExchangeNames()
    }
}
