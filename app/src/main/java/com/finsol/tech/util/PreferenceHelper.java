...
public class PreferenceHelper {
    ...
    public static PreferenceHelper getPrefernceHelperInstance() {
    ...
    public void saveMap(Context appContext, String mapName, Map<String,String> inputMap){
    ...
    public HashMap<String,String> loadMap(Context appContext, String mapName){
        HashMap<String,String> outputMap = new HashMap<String,String>();
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(appContext);
        try{

                String jsonString = sharedPreferences.getString(mapName, (new JSONObject()).toString());
